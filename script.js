    ...
    "hair": [
        {
            ...
            "autor": "Анна Сансара",
            "date": "11 апреля",
            "avatar": "./src/images/avaAnna.jpg",
            "img": "./src/images/hair1.jpg",
            "profile": "./pages/anna.html"
        },
        {
                ...
                <div class="col-md-12">
                    <div
                        ...
                        <div class="col p-4 d-flex flex-column position-static">
                            <h3 class="mb-0">${temporaryTag[i].title}</h3>
                            <div class="mb-1 text-muted">${temporaryTag[i].date}</div>
